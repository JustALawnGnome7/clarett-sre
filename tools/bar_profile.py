...
map (spec/clarett-8prex-fcp-transport.md §8). The point: capture a PCM streaming session and see
which *new* registers light up — those are the data-plane DMA engine (ring base / size / pointer /
control). See spec/clarett-8prex-data-plane.md for the capture plan.
