 ...
 * — verified offline for every model by tools/fcp_decode.py --deblob-check and tools/test_deblob.c
 * (which reconstructs the command stream from these tables and diffs it against the original blob).
 *
 * The per-model tables live in clarett_arm_<model>.h (generated by fcp_decode.py --emit-deblob).
